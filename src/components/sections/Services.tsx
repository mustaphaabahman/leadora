...
const CustomImageIcon = ({ src, alt, className }: { src: string, alt: string, className?: string }) => (
  <div className={`w-full h-full flex items-center justify-center ${className} overflow-visible`}>
    <Image src={src} alt={alt} width={256} height={256} quality={100} unoptimized={true} className="w-full h-full object-contain filter mix-blend-screen" />
  </div>
);
            ...
            return (
              ...
              >
                ...
                <motion.div 
                  ...
                  className="w-full flex items-center justify-start mb-6 relative transition-transform duration-300 ease-in-out group-hover:scale-110"
                >
                  <Icon className="w-24 h-24 sm:w-28 sm:h-28 relative z-10 transition-all duration-300 drop-shadow-[0_0_15px_rgba(255,255,255,0.2)] group-hover:drop-shadow-[0_0_25px_rgba(255,255,255,0.4)]" />
                </motion.div>
